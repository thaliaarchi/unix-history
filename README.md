...
project and his, in turn, has broadened my search.

## License

Commentary is copyright Thalia Archibald and released under a [BSD-3-Clause license](LICENSE). \
The sources transcribed and excerpted are copyright their authors. \
Snippets of UNIX source code are released under a [BSD-4-Clause license](LICENSE-CALDERA).
