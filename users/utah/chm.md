...
Utah-related items in the [Computer History Museum Collections](https://computerhistory.org/collections/).
...
- 102639874: ["The Inception of Computer Graphics at the University of Utah"](https://www.computerhistory.org/collections/catalog/102639874/) \
  Sun Microsystems (Distributor), Bay Area Computer Perspectives (Publisher) \
  Frank Crow (Speaker), Lance Williams (Speaker), Edwin Catmull (Speaker), John
  Warnock (Speaker) \
  Talk, VHS, 1994-09-27 (Made)

  Includes speech-to-text with linked timestamps.

  > Recorded during a joint meeting of the Silicon Valley Special Interest Group
  > in Graphics (SIGGRAPH) and Bay Area Computer Perspectives, speakers John
  > Warnock (Adobe), Ed Catmull (Pixar), Frank Crow (Apple), and Lance Williams
  > (Apple) discuss their various experiences at the University of Utah, a
  > center for computer graphics research. Warnock begins by recounting the
  > founding of the Utah graphics lab, and the individuals who moved on to bring
  > Utah’s graphics techniques to Silicon Valley. Catmull discusses his early
  > experiences as a student, including stories of his classes with Alan Kay,
  > and screens his 1972 student film The Computer Animated Hand, and tells of
  > his interactions with his advisor, Ivan Sutherland. Crow displays a series
  > of slides of computer graphics and of University of Utah, including work by
  > Warnock, Bui Tuong-Phong, and Ron Resch, as well as the lab environments and
  > the devices used there like the DEC PDP-10 computer, Evans & Sutherland
  > frame buffers, drum scanners, line drawing systems, and a specially-built
  > film recorder. Williams discusses work by Jef Raskin, including the FLOW
  > language, and compares the work being done at Utah with Ohio State, and
  > reads a paper he wrote from roughly 1975 describing his vision of the
  > requirements for advancing computer graphics. Following the presentation is
  > an extended audience question and answer session, followed by a screening of
...
- X398.84: ["The Utah Teapot"](https://www.computerhistory.org/collections/catalog/X398.84/) \
  ...
  > set is based. The teapot has frequently been used to test techniques of
  > rendering three-dimensional objects using computer graphics. Teapots
  > rendered as a wire frame outline- Warnock- Gouraud and Phong shaded have
  > been published as well as many versions with simulated reflections of an
  > environment- and shape distortions. The frequency of use of the teapot as a
  > test object in computer graphics has given it the status of a benchmark.
...
- 102672452: ["University of Utah Teapot - Original"](https://www.computerhistory.org/collections/catalog/102672452/) \
  ...
  > distributed teapot data set is based. The teapot has frequently been used to
  > test techniques of rendering three-dimensional objects using computer
  > graphics. Teapots rendered as a wire frame outline- Warnock- Gouraud and
  > Phong shaded have been published as well as many versions with simulated
  > reflections of an environment- and shape distortions. The frequency of use
  > of the teapot as a test object in computer graphics has given it the status
  > of a benchmark. Data for the teapot created and input by Martin Newell-
...
- 102672453: ["Wire-frame model of the Utah Teapot"](https://www.computerhistory.org/collections/catalog/102672453/) \
  ...
  > outline \
  > Verso: "Milochik:" in pencil. "University of Utah Computer Science" printed
...
- 102757124: ["3D Printed Ceramic Teapot"](https://www.computerhistory.org/collections/catalog/102757124/) \
  ...
  > teapot created in 1975 by Martin Newell, a PhD student at the university of
  > Utah. It is a simple, round, partially concave mathematical model of an
  > ordinary Melitta teapot. There is a separate teapot lid.
...
- 102710362: ["University of Utah model Head with three Graphic Views"](https://www.computerhistory.org/collections/catalog/102710362/) \
  ...
  > B&W graphic image of a head with three graphic views. \
  > Metadata: Figure 2.3 - the images (b), (c) and (d) were generated using data
...
- 102710367: ["University of Utah Graphic Head with Smoothing"](https://www.computerhistory.org/collections/catalog/102710367/) \
  ...
  > B&W graphic image of a head with smoothing
...
- 102710360: ["Wireframe model of Sutherland’s Volkswagen"](https://www.computerhistory.org/collections/catalog/102710360/) \
  ...
  > B&W graphic image of a Volkswagen car "wire view." \
  > Image has vertical dash lines on right and left of image. The left lines
  > have PAUSE . \
  > Recto bottom margin: "University of Utah Computer Science"
- 102710361: ["Rendering of Sutherland’s Volkswagen"](https://www.computerhistory.org/collections/catalog/102710361/) \
  Courtesy of the School of Computing at the University of Utah \
  University of Utah \
  Photograph, Circa 1977 (Made) \
  Acquisition number X7413.2015
...
- 102710363: ["University of Utah Volkswagen Graphic Smooth View"](https://www.computerhistory.org/collections/catalog/102710363/) \
  ...
  > B&W graphic image of a Volkswagen car showing planes. \
  > Recto bottom margin: "University of Utah Computer Science"
- 102714326: ["Mapping Sutherland’s Volkswagen"](https://www.computerhistory.org/collections/catalog/102714326/) \
  Courtesy of the School of Computing at the University of Utah \
  Snapshot, Circa 1977 (Made) \
  Acquisition number X5598.2010
...
- 102693568: ["Robots - Utah/M.I.T. Dextrous Hand"](https://www.computerhistory.org/collections/catalog/102693568/) \
  ...
  > assembly. In the background is the control panel. \
  > "UTAH/M.I.T. Dextroud Hand Artificial Intelligence Lab Mass. Institute of
  > Tech Center for Biomedical Design University of Utah"
